...
credit ="😎𝖘:)™~" 
OWNER = int(os.environ.get("OWNER", 7001787251))
try: 
    ADMINS=[] 
    for x in (os.environ.get("ADMINS", "7001787251").split()):  
        ADMINS.append(int(x)) 
except ValueError: 
...
bot = Client("bot",    
   bot_token="7732456513:AAFSHuITtXPotuAtxmKntDisWbpIsmHhetQ",    
   api_id= 27032249,    
...
@bot.on_message(filters.command(["ryzen"]))    
async def account_login(bot: Client, m: Message):    
